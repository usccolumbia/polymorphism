...
- The codes for the paper can be found in codes folder where each notebook explains the procedure to plot the figures.
- To find similar structures,
  ...
  - you can use the following command to find and plot similar structures:
    
    ```bash
    python mapping_structures/find_similar.py icsd/19 --plot --include-icsd
    ```
  - or view_similar.ipynb should be used then to plot those similar structures.
